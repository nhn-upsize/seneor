-- ============================================================
-- Sensor Tower Market Analysis API - DB Schema (v8)
-- 대상 DB: PostgreSQL
-- 수정일: 2026-04-13
-- v8: v7 대비 변경사항
--     - st_app_demographics / st_demographics_baseline 수집 완료 (Q1 2022 ~ Q1 2026, 17분기)
--     - dw_app_monthly에 demographics JOIN 추가 (분기→월 forward-fill, 89% 커버)
--     - collect_demographics() 버그 수정: API 응답 dict→list, cursor 닫힘
-- v7 변경사항
--     - st_master_apps / st_master_publishers 제거
